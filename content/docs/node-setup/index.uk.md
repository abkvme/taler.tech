...
Цей посібник охоплює налаштування та запуск повного вузла блокчейну TALER Blockchain.

## Що таке вузол TALER Blockchain?
...
Вузли TALER знаходять інші вузли через комбінацію вбудованих сідів та списку сідів спільноти, розміщеного на GitHub. Якщо ви запускаєте вузол з надійним аптаймом, ви можете додати його до списку сідів, щоб допомогти зміцнити мережу.

**Детальніше**: [Сід-сервери спільноти](/uk/docs/seed-servers/) - Як працює виявлення вузлів та як додати свій вузол

**Репозиторій списку сідів**: [github.com/abkvme/taler-seeds](https://github.com/abkvme/taler-seeds)

---

## Наступні кроки

- **Сід-сервери**: Дізнайтеся про виявлення вузлів та додайте свій вузол у [Сід-сервери спільноти](/uk/docs/seed-servers/)
- **Командний рядок**: Дізнайтеся про розширені опції `talerd` у посібнику [Node CLI](/uk/docs/node-cli/)
- **Розгортання Docker**: Запустіть вузол TALER у контейнерах з [Docker](/uk/docs/node-docker/)
- **Майнінг і стейкінг**: Беріть участь у генерації блоків у [Mining & Staking](/uk/docs/node-mining/)
