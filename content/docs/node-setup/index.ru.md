...
Это руководство охватывает настройку и запуск полного узла блокчейна TALER Blockchain.

## Что такое узел TALER Blockchain?
...
## Сид-серверы сообщества

Узлы TALER находят другие узлы через комбинацию встроенных сидов и списка сидов сообщества, размещённого на GitHub. Если вы запускаете узел с надёжным аптаймом, вы можете добавить его в список сидов, чтобы помочь укрепить сеть.

**Подробнее**: [Сид-серверы сообщества](/ru/docs/seed-servers/) - Как работает обнаружение узлов и как добавить свой узел

**Репозиторий списка сидов**: [github.com/abkvme/taler-seeds](https://github.com/abkvme/taler-seeds)

---

## Следующие шаги

- **Сид-серверы**: Узнайте об обнаружении узлов и добавьте свой узел в [Сид-серверы сообщества](/ru/docs/seed-servers/)
- **Командная строка**: Узнайте о расширенных опциях `talerd` в руководстве [Node CLI](/ru/docs/node-cli/)
- **Развертывание Docker**: Запустите узел TALER в контейнерах с [Docker](/ru/docs/node-docker/)
- **Майнинг и стейкинг**: Участвуйте в генерации блоков в [Mining & Staking](/ru/docs/node-mining/)
