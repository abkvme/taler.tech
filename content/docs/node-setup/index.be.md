...
Гэта кіраўніцтва ахоплівае наладку і запуск поўнага вузла блакчэйна TALER Blockchain.

## Што такое вузел TALER Blockchain?
...
Вузлы TALER знаходзяць іншыя вузлы праз камбінацыю ўбудаваных сідаў і спісу сідаў супольнасці, размешчанага на GitHub. Калі вы запускаеце вузел з надзейным аптаймам, вы можаце дадаць яго ў спіс сідаў, каб дапамагчы ўмацаваць сетку.

**Падрабязней**: [Сід-серверы супольнасці](/be/docs/seed-servers/) - Як працуе выяўленне вузлоў і як дадаць свой вузел

**Рэпазіторый спісу сідаў**: [github.com/abkvme/taler-seeds](https://github.com/abkvme/taler-seeds)

---

## Наступныя крокі

- **Сід-серверы**: Даведайцеся аб выяўленні вузлоў і дадайце свой вузел у [Сід-серверы супольнасці](/be/docs/seed-servers/)
- **Загадны радок**: Даведайцеся аб пашыраных опцыях `talerd` у кіраўніцтве [Node CLI](/be/docs/node-cli/)
- **Разгортванне Docker**: Запусціце вузел TALER у кантэйнерах з [Docker](/be/docs/node-docker/)
- **Майнінг і стэйкінг**: Удзельнічайце ў генерацыі блокаў у [Mining & Staking](/be/docs/node-mining/)
