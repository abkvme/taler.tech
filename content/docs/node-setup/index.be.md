...
Загрузіце апошняе праграмнае забеспячэнне вузла TALER з афіцыйнага рэпазіторыя GitHub:
...
|-----------|------|----------|
| **Windows (64-bit)** | `taler-v0.18.44.7-win64.zip` | Бінарнікі Windows 10/11 |
| **macOS (M1/M2/M3+)** | `taler-v0.18.44.7-macos-arm64.tar.gz` | Натыўная зборка Apple Silicon |
| **Linux (64-bit)** | `taler-v0.18.44.7-linux-x64.tar.gz` | Бінарнікі Linux x86_64 |
| **Linux (ARM64)** | `taler-v0.18.44.7-linux-arm64.tar.gz` | Бінарнікі ARM64/aarch64 |
...
1. **Выняце архіў**:
   - Пстрыкніце правай кнопкай мышы `taler-v0.18.44.7-win64.zip`
   - Абярыце "Выняць усё..."
