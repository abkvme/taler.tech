---
title: "History"
description: "An informal community account of how TALER came to be - from the 2017 launch on walletbuilders.com through the Lyra2Z hardfork and the early-2018 peak."
weight: 10
---
...
The fork happened at **block 10,000 on November 24, 2017**. Around the same time, TALER got its first (and at that point, only) full-time developer, and the project got its public repository at [github.com/taler-project/taler](https://github.com/taler-project/taler/).
...
- An [Onliner interview from 23 January 2018](https://tech.onliner.by/2018/01/23/taler-2) where Lavnikevich openly named the 10% premine (~2.2M coins), listed three operational mining pools (`taler-pool.online`, `talerpool.by`, `tlr.idcray.com`), promised international exchange listings by early February and Belarusian listings after Decree No. 8 took effect on **28 March 2018**, and described the premine as funding for infrastructure, social media, exchange-listing fees, and "free TALER for small businesses." His main answer to scam accusations was a meta-argument: *"creators of scam projects don't advertise themselves… we are maximally transparent."*
- A [dev.by retrospective from the Creators themselves](https://dev.by/news/nastoyaschaya-istoriya-talera-dramatichnye-momenty-sozdaniya-pervoy-belorusskoy-kriptovalyuty) describing Lavnikevich (economist) studying blockchain since January 2017, Lavrinenko (IT manager) joining later, the first transaction on **13 September 2017**, the public announcement on **6 October 2017**, and dramatic moments such as government officials asking them to postpone the press conference and Lavnikevich being dropped from the SmartTaler 2017 conference program on **25 November**. The piece frames TALER as "developed by us" with a focus on business adoption.
...
Right after that, Lavnikevich said *he too* was leaving the project, and that the entire premine would be transferred to **Veyshnoria**. The exit was reported on **23 February 2018**: [dev.by - TALER creators are done with it](https://dev.by/news/crypto-taler-creators-are-done-with-it).
...
Further reading: [Wikipedia](https://en.wikipedia.org/wiki/Veyshnoria) · [Meduza - five years on](https://meduza.io/feature/2022/09/04/pyat-let-nazad-v-belorusskom-internete-pridumali-veyshnoriyu-gosudarstvo-mem-a-v-2022-m-smi-s-takim-zhe-nazvaniem-ob-yavili-ekstremistskim) · [Astapova & Navumau, 2018](https://www.academia.edu/37653890/Astapova_A_Navumau_V_2018_Veyshnoria_A_Fake_Country_in_the_Midst_of_Real_Information_Warfare_Journal_of_American_Folklore_131_522_435_443).
...
1. A public report to the community of where the rest of the premine had gone (besides whatever was being handed over).
2. A clear, working mechanism for transferring the premine.
...
The Veyshnoria side registered **talercrypto.com**, opened a Telegram channel at [t.me/taler_crypto](https://t.me/taler_crypto), and - since the original GitHub repository was controlled by us (the developer was on our side), while only **taler.site** was controlled by the Creator - rewrote every reference in the source code to point at the new site.

In response, the Creator camp forked the repository to [github.com/TalerTeam/taler](https://github.com/TalerTeam/taler) and patched the in-app GitHub links in their wallet to point at their fork. They also became extremely fond of describing themselves as *"official."*
...
There was a third faction in this whole circus - **del espirit** and **SG** - running their own chat at [t.me/taleronline](https://t.me/taleronline). They are probably still in there pouring bile on both the Creator and Veyshnoria. It reads like a stream of pure spite. The author left that chat long ago - the regulars there appear to have made trash-talking everyone the entire purpose.

A snapshot of how the situation looked from the inside during the hot summer of 2018 is preserved here: [Google Doc - TALER status report](https://docs.google.com/document/d/1bJzDrKg90hOXbQUQUuLwCopCjSY1eKNi90iJjAmcU48/edit?usp=sharing).
...
1. Build the **Taler Pay** payment system.
2. Launch a YouTube blog.
3. Issue **"Taler Business"** tokens on Ethereum.
...
The full release history lives at [github.com/cryptadev/taler/releases](https://github.com/cryptadev/taler/releases). It is, by some distance, the calmest stretch in the page you are currently reading.
...
- **November 2025.** The first big release. Native **Apple Silicon (M1/M2/M3+)** builds - finally - without Rosetta. Full **Linux ARM64** support for Raspberry Pi and ARM servers. The internal wallet database got a long-overdue modernization, which is also the change that breaks `wallet.dat` compatibility - so for once a release note actually starts with *"back up your wallet before upgrading."* New TALER icon, fresh DNS seeds on **taler.tech**, official multi-architecture Docker images, and a real CI/CD pipeline (which, on this project, almost qualifies as a luxury feature).
- **March 2026.** Network and UX polish. A new **Nodes** page showing seeds and discovered peers with a built-in connectivity checker - so the question *"is the network alive?"* now has a button instead of a hunch. A new **About / Info** page with the project, explorer, and community links, since the previous answer was usually a forwarded screenshot. Missing translations filled in across all 33 supported languages - yes, the wallet now speaks 33 languages, none of which fix chat moderation.
...
A community Telegram remains open at [t.me/talercommunity](https://t.me/talercommunity).

On the exchange side, TALER was recently added to **Qutrade** - trading pair: [TLR/USDT](https://qutrade.io/en/?market=tlr_usdt). The first fresh listing in a long time.
...
- Main site: [taler.tech](https://taler.tech/)
- Block explorer: [explorer.taler.tech](https://explorer.taler.tech/)
- Active wallet (0.19 branch): [github.com/abkvme/taler](https://github.com/abkvme/taler) - [discussions](https://github.com/abkvme/taler/discussions), [issues](https://github.com/abkvme/taler/issues)
- Long-running 0.17 branch: [github.com/cryptadev/taler](https://github.com/cryptadev/taler)
- Community Telegram: [t.me/talercommunity](https://t.me/talercommunity)
...
- [Crex24](https://crex24.com/) - TLR/BTC (low volume)
- [STEX](https://stex.com/) - TLR/BTC (low volume)
...
- [Coinbase price page](https://www.coinbase.com/price/taler)

**Historical project sites, chats and socials (still online):**

- [talercrypto.com](https://talercrypto.com/) - the Veyshnoria-team site
...
- [t.me/talercommunity](https://t.me/talercommunity) - current community chat
- [t.me/taler_crypto](https://t.me/taler_crypto) - the original Veyshnoria Telegram channel
- [t.me/talernews](https://t.me/talernews) - Telegram news channel
- [@taler_wallet_bot](https://t.me/taler_wallet_bot) - Telegram wallet bot
- [t.me/taleronline](https://t.me/taleronline) - the TalerOnline / SG / del espirit faction chat
- [github.com/TalerTeam/taler](https://github.com/TalerTeam/taler) - the Creator camp's fork
- [github.com/taler-project/taler](https://github.com/taler-project/taler) - the 2017 first-developer repository
- Mining pool: [pool.vie.today](https://pool.vie.today/)
- bitcointalk: [thread #1 (early ANN, 2018)](https://bitcointalk.org/index.php?topic=2649237.0) · [thread #2](https://bitcointalk.org/index.php?topic=3758679.0)

**Articles and press:**

- Probusiness.io, October 2017 - [early founders' profile](https://probusiness.io/tech/3905-zhurnalist-i-aytishnik-sozdali-belorusskuyu-kriptovalyutu-chto-oni-s-ney-budut-delat.html)
- Charter97, December 2017 - [Chinese ASIC attack and the planned algorithm switch](https://charter97.org/ru/news/2017/12/25/273576/)
- Onliner, January 2018 - [the creators' interview at the peak](https://tech.onliner.by/2018/01/23/taler-2)
- dev.by - [the creators' own retrospective](https://dev.by/news/nastoyaschaya-istoriya-talera-dramatichnye-momenty-sozdaniya-pervoy-belorusskoy-kriptovalyuty)
- Jillian Godsil, Medium, February 2018 - [English-language peak-period coverage](https://jilliangodsil.medium.com/taler-belarus-now-open-for-cryptocurrency-4c2efc15ec1e)
- dev.by, February 2018 - [TALER creators are done with it](https://dev.by/news/crypto-taler-creators-are-done-with-it)
- Sputnik Belarus, February 2021 - [«Bitcoin in Belarusian: life and death»](https://sputnik.by/economy/20210216/1046918525/Bitkoin-po-belorusski-zhizn-i-smert-pervoy-otechestvennoy-kriptovalyuty.html)
- Kaktotak.by, May 2021 - [does TLR have the right to live?](https://kaktotak.by/en/vsego-ponemnogu/kriptovaliuta-tlr-belorusskii-taler-imeet-li-pravo-na-zhizn)
- HappyCoin Club - [TALER overview](https://happycoin.club/en/kriptovalyuta-iz-belarusi-taler-tlr/)
- Nasha Niva, October 2020 - [the fake-experts investigation](https://nashaniva.by/?c=ar&i=260885&lang=ru)
- [Mid-2018 status snapshot (Google Doc)](https://docs.google.com/document/d/1bJzDrKg90hOXbQUQUuLwCopCjSY1eKNi90iJjAmcU48/edit?usp=sharing)
...
- Meduza, August 2017 - [where the meme started](https://meduza.io/shapito/2017/08/31/organizatory-voennyh-ucheniy-zapad-2017-pereimenovali-chast-belorussii-v-veyshnoriyu-etoy-strane-uzhe-pridumali-flag-gerb-i-pasport)
- Meduza, September 2022 - [five-year retrospective and the "extremist" ruling](https://meduza.io/feature/2022/09/04/pyat-let-nazad-v-belorusskom-internete-pridumali-veyshnoriyu-gosudarstvo-mem-a-v-2022-m-smi-s-takim-zhe-nazvaniem-ob-yavili-ekstremistskim)
- Astapova & Navumau, 2018 - [Veyshnoria: A Fake Country in the Midst of Real Information Warfare](https://www.academia.edu/37653890/Astapova_A_Navumau_V_2018_Veyshnoria_A_Fake_Country_in_the_Midst_of_Real_Information_Warfare_Journal_of_American_Folklore_131_522_435_443) (Journal of American Folklore)
