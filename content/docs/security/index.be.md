...
Файл `wallet.dat` - гэта **адзіная крыніца праўды** для вашага кашалька TALER Blockchain. Гэты файл базы дадзеных Berkeley DB змяшчае ўсё неабходнае для доступу і выдатку вашых манет:
...
**Важна**: Калі вы ўпершыню ствараеце кашалёк TALER Blockchain, ён **цалкам незашыфраваны**.
...
Для значных колькасцяў TALER Blockchain:
...
Кашалёк TALER Coin выкарыстоўвае Berkeley DB з уключаным прыватным рэжымам па змаўчанні (сцяжок `-privdb`).
