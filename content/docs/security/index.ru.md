...
Это руководство охватывает основные практики безопасности для защиты вашего кошелька и активов TALER Blockchain.

## Понимание wallet.dat - единственный источник истины вашего кошелька

### Что такое wallet.dat?

Файл `wallet.dat` является **единственным источником истины** для вашего кошелька TALER Blockchain. Этот файл базы данных Berkeley DB содержит все необходимое для доступа и расходования ваших монет:
...
**Важно**: Когда вы впервые создаете кошелёк TALER Blockchain, он **полностью незашифрован**.
...
Для значительных сумм TALER Blockchain:
