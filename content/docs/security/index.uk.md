...
Файл `wallet.dat` - це **єдине джерело істини** для вашого гаманця TALER Blockchain. Цей файл бази даних Berkeley DB містить все необхідне для доступу та витрачання ваших монет:
...
**Важливо**: Коли ви вперше створюєте гаманець TALER Blockchain, він **повністю незашифрований**.
...
Для значних кількостей TALER Blockchain:
...
Гаманець TALER Coin використовує Berkeley DB з увімкненим приватним режимом за замовчуванням (прапорець `-privdb`).
